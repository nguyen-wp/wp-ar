...
?>
	...
	<div class="wp-block-group">
		<!-- wp:navigation {"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"fontSize":"small"} -->
			...
			<!-- wp:buttons -->
			<div class="wp-block-buttons sm:!hidden sm:hidden!"><!-- wp:button {"backgroundColor":"accent-3","textColor":"base","style":{"elements":{"link":{"color":{"text":"var:preset|color|base"}}},"spacing":{"padding":{"left":"var:preset|spacing|20","right":"var:preset|spacing|20"}}},"fontSize":"small"} -->
