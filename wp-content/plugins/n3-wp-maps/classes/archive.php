                ...
                <div class="wp-block-group has-global-padding is-layout-constrained wp-block-group-is-layout-constrained">
                    <div class="wp-block-group alignwide">
                        <div class="flex flex-col md:flex-row my-10 text-base">
                                    ...
                                    <div class="grid gap-10">
                                        ...
                                        ?>
                                            <div class="wp-block-post-content text-base">
                                                ...
                                                <div class="mb-2 leading-none space-x-3">
                                                ...
                                                <div class="mb-5 leading-none space-x-3">
                                                    <span class="leading-none text-sm">
                                                        <span class="font-medium text-gray-900 whitespace-nowrap">Address:</span>
                                                        <span class="text-gray-700"><?php echo $fields['map']['address']; ?></span>
                                                    </span>
                                                </div>
                                                <div class="wp-block-post-content text-base">
                                                    <?php the_excerpt(); ?>
                            ...
                            <?php if (get_option('nguyenmapasidebar_archive') !== 'no') : ?>
                                <div clas="sidebar">
                                    <?php 
