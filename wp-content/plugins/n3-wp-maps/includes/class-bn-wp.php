...
class MADE_WP_MAPS {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      MADE_WP_MAPS_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->MADEWP_LightWeight['nicename'] = MADE_WP_MAPS_NICENAME;
		$this->MADEWP_LightWeight['prefix'] = MADE_WP_MAPS_PREFIX;
		$this->MADEWP_LightWeight['version'] = MADE_WP_MAPS_VERSION;
	 ...
	 *
	 * - MADE_WP_MAPS_Loader. Orchestrates the hooks of the plugin.
	 * - MADE_WP_MAPS_i18n. Defines internationalization functionality.
	 * - MADE_WP_MAPS_Admin. Defines all hooks for the admin area.
	 *
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		$this->loader = new MADE_WP_MAPS_Loader();
	 ...
	 *
	 * Uses the MADE_WP_MAPS_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new MADE_WP_MAPS_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new MADE_WP_MAPS_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new MADE_WP_MAPS_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    MADE_WP_MAPS_Loader    Orchestrates the hooks of the plugin.
	 */
