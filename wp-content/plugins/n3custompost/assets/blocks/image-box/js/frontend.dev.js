    ...
    */
    ...
    !function (n) {
      n(document).ready(function (t) {
        ...
        var i = function i() {
          n(".wp-block-n3custompost-image-box:not(.n3custompost-init)").each(function (t, i) {
            n(i).addClass("n3custompost-init"), n(".n3custompost-animation.wp-block-n3custompost-image-box").on("mouseenter", function () {
              Object(o.a)(n(this).find(".wp-block-n3custompost-image-box__image-wrapper"), {
