...
class FontIconsManager {
	...
	public function __construct() {
		...
		add_filter( 'n3custompost/editor_blocks_js/localize_data', [ $this, 'setIconsListLocalizeData' ] );
		add_filter( 'n3custompost/editor_blocks_css/dependencies', [ $this, 'enqueueFonts' ] );
	...
	public function getDefaultFontHandle() {
		return apply_filters(
			'n3custompost/icons_manager/default_font_handle',
	...
	public function extendFontIcons() {
		...
		do_action( 'n3custompost/icons-manager/init', $this );
	}
	...
	private function registerFontAwesome() {
		...
		$this->registerFont(
			...
			[
				'icons' => require( N3BLOCK_PLUGIN_DIR . 'includes/data-list/font-awesome-icon-list.php' ),
				'handle' => $this->getDefaultFontHandle(),
				'src' => n3custompost_get_plugin_url( 'vendors/fontawesome-free/css/all.min.css' ),
				'deps' => null,
				'ver' => '5.5.0',
			]
		);
