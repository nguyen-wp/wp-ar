		...
		$field  = get_field_object( $attributes[ 'customField' ], get_the_ID() );
	 	...
	 	if ( $field ) :
 			...
 			if ( ! empty( $attributes[ 'labelName' ] ) ) {
				$output .= '<span class="' . esc_attr( 'wp-block-n3custompost-template-acf-select__label' ) . '">' . esc_html( $attributes[ 'labelName' ] ) . '</span>';
			}
						...
						case 'label' : {
							if ( $fieldIsMultiple ) {
								...
								foreach ( $fieldValue as $value ) {
									...
									$output .= '<span class="wp-block-n3custompost-template-acf-select__value ' . esc_attr( 'option-' . strtolower( $getValue ) ) . '">';
								...
								$output .= '<span class="wp-block-n3custompost-template-acf-select__value ' . esc_attr( 'option-' . strtolower( $fieldValue ) ) . '">';
						...
						case 'array' :
							if ( $fieldIsMultiple ) {
								...
								foreach ( $fieldValue as $value ) {
									...
									$output .= '<span class="wp-block-n3custompost-template-acf-select__value ' . esc_attr( 'option-' . strtolower( $getValueArray ) ) . '">';
								...
								$output .= '<span class="wp-block-n3custompost-template-acf-select__value ' . esc_attr( 'option-' . strtolower( $fieldValue[ 'value' ] ) ) . '">';
