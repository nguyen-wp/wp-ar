...
class Icon extends \N3Block\Blocks\AbstractBlock {

	protected static $blockName = 'n3custompost/icon';
    ...
    public function block_frontend_assets() {
		...
		wp_enqueue_style(
			self::$blockName,
			n3custompost_get_plugin_url( 'assets/blocks/icon/style' . $rtl . '.css' ),
			$deps,
		...
		wp_enqueue_script(
            self::$blockName,
            n3custompost_get_plugin_url( 'assets/blocks/icon/frontend.js' ),
            [ 'jquery' ],
            n3custompost()->settings()->getVersion(),
            true
        );
