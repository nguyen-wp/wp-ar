...
class SocialLinks extends \N3Block\Blocks\AbstractBlock {

	protected static $blockName = 'n3custompost/social-links';
	...
	public function getLabel() {
		return __('Social Links', 'n3custompost');
	}
    ...
    public function block_frontend_assets() {
		...
		wp_enqueue_style(
			self::$blockName,
			n3custompost_get_plugin_url( 'assets/blocks/social-links/style' . $rtl . '.css' ),
			$deps,
...
n3custompost()->blocksManager()->addBlock(
	new \N3Block\Blocks\SocialLinks()
);
