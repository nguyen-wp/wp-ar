...
class PostTags extends \N3Block\Blocks\AbstractBlock {

	protected static $blockName = 'n3custompost/template-post-tags';
    ...
    public function render_callback( $attributes, $content ) {
        ...
        $block_name = 'wp-block-n3custompost-template-post-tags';
        ...
        if ($tags_list) {
            ...
            n3custompost_get_template_part( 'template-parts/post-tags', $attributes, false, $extra_attr );
