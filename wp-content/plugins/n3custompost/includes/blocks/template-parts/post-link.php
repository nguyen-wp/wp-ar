...
class PostLink extends \N3Block\Blocks\AbstractBlock {

	protected static $blockName = 'n3custompost/template-post-link';
    ...
    public function render_callback( $attributes, $content ) {
        ...
        $block_name = 'wp-block-n3custompost-template-post-link';
        ...
        n3custompost_get_template_part( 'template-parts/post-link', $attributes, false, $extra_attr );
