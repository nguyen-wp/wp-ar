...
class PostComments extends \N3Block\Blocks\AbstractBlock {

	protected static $blockName = 'n3custompost/template-post-comments';
    ...
    public function render_callback( $attributes, $content ) {
        ...
        $block_name = 'wp-block-n3custompost-template-post-comments';
        ...
        if ( comments_open() || get_comments_number() ) {
            ...
            n3custompost_get_template_part( 'template-parts/post-comments', $attributes, false, $extra_attr );
...
new \N3Block\Blocks\PostComments();
