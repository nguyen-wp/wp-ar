...
class PostAuthor extends \N3Block\Blocks\AbstractBlock {

	protected static $blockName = 'n3custompost/template-post-author';
    ...
    public function __construct() {
        ...
        register_block_type(
            'n3custompost/template-post-author',
            array(
                'attributes' => array(
                    'blockDivider' => array(
                        'type' => 'string'
    ...
    public function render_callback( $attributes, $content ) {
        ...
        $block_name = 'wp-block-n3custompost-template-post-author';
        ...
        if ( get_the_author() ) {
            ...
            n3custompost_get_template_part( 'template-parts/post-author', $attributes, false, $extra_attr );
