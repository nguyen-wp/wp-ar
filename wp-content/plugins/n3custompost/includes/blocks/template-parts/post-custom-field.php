...
class PostCustomField extends \N3Block\Blocks\AbstractBlock {

	protected static $blockName = 'n3custompost/template-post-custom-field';
    ...
    public function render_callback( $attributes, $content ) {
        ...
        $block_name = 'wp-block-n3custompost-template-post-custom-field';
        ...
        if ( isset( $attributes[ 'customField' ] ) ) {
            ...
            n3custompost_get_template_part( 'template-parts/post-custom-field', $attributes, false, $extra_attr );
...
new \N3Block\Blocks\PostCustomField();
