...
class AcfBackgroundImage extends \N3Block\Blocks\AbstractBlock {

	protected static $blockName = 'n3custompost/template-acf-background-image';
	...
	public function render_callback( $attributes, $content ) {
		...
		$block_name = 'wp-block-n3custompost-template-acf-background-image';
		...
		if ( n3custompost_acf_is_active() && isset( $attributes['customField'] ) && (has_post_thumbnail()) || strlen( $content ) ) {
			ob_start();

			n3custompost_get_template_part( 'template-parts/acf/background-image', $attributes, false, $extra_attr );
...
new \N3Block\Blocks\AcfBackgroundImage();
