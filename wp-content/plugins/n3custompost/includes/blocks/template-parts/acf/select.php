...
class AcfSelect extends \N3Block\Blocks\AbstractBlock {

	protected static $blockName = 'n3custompost/template-acf-select';
	...
	public function render_callback( $attributes, $content ) {
		...
		$block_name = 'wp-block-n3custompost-template-acf-select';
		...
		if ( n3custompost_acf_is_active() && isset( $attributes['customField'] ) ) {
			...
			n3custompost_get_template_part( 'template-parts/acf/select', $attributes, false, $extra_attr );
