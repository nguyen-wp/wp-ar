...
class ContentSlider extends AbstractBlock {
	...
	protected static $blockName = 'n3custompost/content-slider';
	...
	public function getLabel() {
		return __('Content Slider', 'n3custompost');
	}
	...
	public function block_frontend_assets() {
		...
		wp_enqueue_script(
			self::$blockName,
			n3custompost_get_plugin_url( 'assets/blocks/content-slider/frontend.js' ),
			[ 'jquery', 'slick' ],
