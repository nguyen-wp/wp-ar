        ...
        <footer class="mt-5 text-center">
            ...
            <div class="row small">
                <div class="col-12">
                    ...
                    <p class="text-muted m-0">This is a product of <a href="https://n3commercialrealty.com" target="_blank">Restore Construction</a>. Copyright &copy; <?php echo date('Y'); ?>. All rights reserved.</p>
                </div>
            </div>
        </footer>
    </div>
